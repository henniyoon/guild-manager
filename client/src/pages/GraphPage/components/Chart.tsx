  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const sortedData = data.sort((a: { week: string; }, b: { week: string; }) => {
        ...
        const weeklyScores = sortedData.map((item: { weekly_score: any; }) => item.weekly_score);
        const suroScores = sortedData.map((item: { suro_score: any; }) => item.suro_score);
        const flagScores = sortedData.map((item: { flag_score: any; }) => item.flag_score);
